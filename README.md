...
| `WEB_CONSOLE_USERNAME`      | 网页控制台登录的用户名（可选）。与密码配合使用。                                                                                                          | 无                   |
| `WEB_CONSOLE_PASSWORD`      | 网页控制台登录的密码（可选）。如果不设置或仅设置 API 密钥，平台将使用 API 密钥作为登录凭证。反之，如果设置了该密码，登录则使用此密码，不再使用 API 密钥。 | 无                   |
| `PORT`                      | API 服务器端口。                                                                                                                                          | `7860`               |
