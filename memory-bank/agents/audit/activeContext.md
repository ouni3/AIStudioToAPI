...
## 1. 核心经验条目 (Max 8)
1. **API / 网关 Caller DX 审查标准**: 重点关注调用心智、响应延迟降维及错误提示亲和度，确保畸形入参在协议入口毫秒级拦截。
...
7. **进化贡献四要素论证**: 体验审计报告必须显式推演 $\Delta F_{System}$ / $\Delta L_{User}$ / $\Delta S_{total}$ / $\Delta Value_{Delivered}$，断言 ECT 等级。
