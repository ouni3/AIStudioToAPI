...
class FormatConverter {
    ...
    static MOCK_EMPTY_THINKING_RESPONSE =
        "[Thinking completed, but no text response was generated by the model.]";
    ...
    convertGoogleToOpenAINonStream(googleResponse, modelName = "gemini-2.5-flash-lite") {
        ...
        const hasThoughts =
            reasoning_content ||
            (googleResponse.usageMetadata && googleResponse.usageMetadata.thoughtsTokenCount > 0);
